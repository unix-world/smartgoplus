...
import (
	...
	"github.com/unix-world/smartgoplus/web-http/securecookie"
)
...
const (
	tokenKey     string = "smartgoext.csrf.Token" // #nosec G101
	formKey      string = "smartgoext.csrf.Form"  // #nosec G101
	errorKey     string = "smartgoext.csrf.Error"
	skipCheckKey string = "smartgoext.csrf.Skip"
	cookieName   string = "_smartgoext_csrf"
	errorPrefix  string = "smartgoplus/web-http/csrf: "
)
...
//		"html/template"
//
//		"github.com/unix-world/smartgoplus/web-http/csrf"
//		"github.com/unix-world/smartgoplus/web-http/mux"
//	)
//
