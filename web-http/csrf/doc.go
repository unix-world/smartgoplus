...
csrf is easy to use: add the middleware to individual handlers with
the below:
...
template, JSON body or HTTP header (you pick!). csrf inspects the form body
...
(https://github.com/unix-world/smartgoplus/web-http/securecookie) library. They're also Secure (issued
