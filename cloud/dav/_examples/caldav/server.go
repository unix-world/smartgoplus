...
import (
	...
	"github.com/unix-world/smartgoext/cloud/ical"

	"github.com/unix-world/smartgoplus/cloud/dav/caldav"
)
...
var testPropFindSupportedCalendarComponentCases = map[*caldav.Calendar][]string{
	&caldav.Calendar{Path: "/user/calendars/cal"}:                                                     []string{"VEVENT"},
	&caldav.Calendar{Path: "/user/calendars/cal", SupportedComponentSet: []string{"VTODO"}}:           []string{"VTODO"},
	&caldav.Calendar{Path: "/user/calendars/cal", SupportedComponentSet: []string{"VEVENT", "VTODO"}}: []string{"VEVENT", "VTODO"},
}
...
func TestPropFindSupportedCalendarComponent(t *testing.T) {
	for calendar, expected := range testPropFindSupportedCalendarComponentCases {
		...
		handler := caldav.Handler{Backend: testBackend{calendars: []caldav.Calendar{*calendar}}}
...
func TestMultiCalendarBackend(t *testing.T) {
	...
	req.Header.Set("Content-Type", "application/xml")
	w := httptest.NewRecorder()
	handler := caldav.Handler{Backend: testBackend{
		calendars: calendars,
...
func (t testBackend) CreateCalendar(ctx context.Context, calendar *caldav.Calendar) error {
	return nil
}

func (t testBackend) ListCalendars(ctx context.Context) ([]caldav.Calendar, error) {
	return t.calendars, nil
}

func (t testBackend) GetCalendar(ctx context.Context, path string) (*caldav.Calendar, error) {
...
func (t testBackend) GetCalendarObject(ctx context.Context, path string, req *caldav.CalendarCompRequest) (*caldav.CalendarObject, error) {
...
func (t testBackend) PutCalendarObject(ctx context.Context, path string, calendar *ical.Calendar, opts *caldav.PutCalendarObjectOptions) (*caldav.CalendarObject, error) {
	return nil, nil
}

func (t testBackend) ListCalendarObjects(ctx context.Context, path string, req *caldav.CalendarCompRequest) ([]caldav.CalendarObject, error) {
	return t.objectMap[path], nil
}

func (t testBackend) QueryCalendarObjects(ctx context.Context, path string, query *caldav.CalendarQuery) ([]caldav.CalendarObject, error) {
	return nil, nil
}
