...
func (*testBackend) ListAddressBooks(ctx context.Context) ([]carddav.AddressBook, error) {
...
func (b *testBackend) GetAddressBook(ctx context.Context, path string) (*carddav.AddressBook, error) {
...
func (b *testBackend) CreateAddressBook(ctx context.Context, ab *carddav.AddressBook) error {
...
func (*testBackend) GetAddressObject(ctx context.Context, path string, req *carddav.AddressDataRequest) (*carddav.AddressObject, error) {
	if path == alicePath {
...
func (b *testBackend) ListAddressObjects(ctx context.Context, path string, req *carddav.AddressDataRequest) ([]carddav.AddressObject, error) {
	p := ctx.Value(addressBookPathKey).(string)
...
func (*testBackend) QueryAddressObjects(ctx context.Context, path string, query *carddav.AddressBookQuery) ([]carddav.AddressObject, error) {
	panic("TODO: implement")
}

func (*testBackend) PutAddressObject(ctx context.Context, path string, card vcard.Card, opts *carddav.PutAddressObjectOptions) (*carddav.AddressObject, error) {
	panic("TODO: implement")
}
...
func TestAddressBookDiscovery(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			h := carddav.Handler{&testBackend{}, tc.prefix}
			...
			client, err := carddav.NewClient(nil, startURL)
			if err != nil {
